            ...
            <div className="mx-6 mt-6 p-4 bg-blue-900/30 border border-blue-400/30 rounded-lg flex items-start gap-3">
              ...
              <div>
                <p className="text-blue-100 text-sm">
                  <span className="font-bold">Token Holders Get Perks:</span> If you hold $VibeOfficial tokens, you'll get special benefits including exclusive badges, 2x XP multiplier, and priority access to LECHE cards!
                </p>
              </div>
            </div>
